...
/* This function is responsible for the determination of the state of the program's nature
   with various cases to determine if we are running a recipe or reading a UART input etc. 
...
/* This function is responsible for processing the input the user entered from the UART.
